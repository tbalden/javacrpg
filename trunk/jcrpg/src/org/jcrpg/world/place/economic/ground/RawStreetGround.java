...
public class RawStreetGround extends EconomicGround {
	
	
	public RawStreetGround() {
		super();
		// TODO Auto-generated constructor stub
	}

	public RawStreetGround(String id, Geography soilGeo, Place parent,
	...
	{
		try {
			return new RawStreetGround(id,soilGeo,parent,loc,sizeX,sizeY,sizeZ,origoX,origoY,origoZ,groundLevel, homeBoundaries, owner);
		} catch (Exception ex)
		{
			ex.printStackTrace();
			System.exit(1);
