...
package org.jcrpg.world.ai.humanoid.group.yeti;
...
public class YetiHunters extends HumanoidEntityDescription {
	...
	public static YetiMaleHunter YETI_MALE_HUNTER = new YetiMaleHunter("YETI_MALE_HUNTER",humanMaleAudio);
...
*/
	public YetiHunters()
	{
		...
		economyTemplate.addResidenceType(Plain.class, Igloo.class);
		economyTemplate.addResidenceType(Forest.class, Igloo.class);
		...
		addGroupingRuleMember(YETI_MALE_HUNTER);
	...
	public static ColorRGBA[][] CITY_COLORED = IconReader.readMapIconFile("./data/ui/mapicons/igloo.ico");
