...
public class PhysicalResistance extends StateEffect {
	...
	public String getIcon() {
		return "physical_resistance.png";
	}
	...
	static
	{
		resis.setResistance(FantasyResistances.RESIST_PIERCE, 10);
		resis.setResistance(FantasyResistances.RESIST_BLUDGEON, 10);
	}
