...
public class BaseFloraGenerator extends FloraGenerator{
	...
	public BaseFloraGenerator()
	{
		...
		addFlora(Continental.CONTINENTAL_ID,ClimateLevel.CLIMATELEVEL_ID,INSIDE,new FloraListElement[]{new FloraListElement(new Grass()),new FloraListElement(new OakTree(),0), new FloraListElement(new CherryTree(),0),new FloraListElement(new GreenPineTree(),30),new FloraListElement(new GreatPineTree(),0),new FloraListElement(new GreenBush(),50)});
