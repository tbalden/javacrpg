...
public class BaseFloraGenerator extends FloraGenerator{
	...
	{
		//addFlora(Continental.CONTINENTAL_ID,ClimateLevel.CLIMATELEVEL_ID,new FloraListElement[]{new FloraListElement(new Grass()),new FloraListElement(new OakTree(),20), new FloraListElement(new CherryTree(),110),new FloraListElement(new GreenPineTree(),110),new FloraListElement(new Acacia(),150),new FloraListElement(new GreenBush(),220)});
		...
		addFlora(Tropical.TROPICAL_ID,ClimateLevel.CLIMATELEVEL_ID,new FloraListElement[]{new FloraListElement(new JungleGround()),new FloraListElement(new CoconutTree(),150),new FloraListElement(new JunglePalmTrees(),300),new FloraListElement(new GreenFern(),420)});
