...
public class JungleLowTree extends Tree {
	
	public static final String TYPE_FOREST = "JUNGLE";
	public static final SideSubType SUBTYPE_TREE = new StickingOut(TYPE_FOREST+"_LOWTREE",TREE_COLOR);
	
	static Side[][] TREE = new Side[][] { null, null, null,null,null,{new Side(TYPE_FOREST,SUBTYPE_TREE)} };
	
	public JungleLowTree()
	{
		super();
		growsOnSteep = true;
