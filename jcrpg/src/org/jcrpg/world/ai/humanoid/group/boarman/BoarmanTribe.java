...
public class BoarmanTribe extends HumanoidEntityDescription {
	...
	public BoarmanTribe()
	{
		...
		economyTemplate.addEcoGroundType(Plain.class, PavedSquareGround.class);
		economyTemplate.addEcoGroundType(Forest.class, RawStreetGround.class);
		economyTemplate.addEcoGroundType(Forest.class, PavedSquareGround.class);
		economyTemplate.addEcoGroundType(Mountain.class, RawStreetGround.class);
		economyTemplate.addEcoGroundType(Mountain.class, PavedSquareGround.class);
