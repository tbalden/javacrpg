...
public class BoarmanTribe extends HumanoidEntityDescription {
	...
	static {
		...
		desc.IDLE = "./data/models/humanoid/boarman/boarman_walk.md5anim";		
		desc.WALK = "./data/models/humanoid/boarman/boarman_walk.md5anim";
		desc.ATTACK_LOWER = "./data/models/humanoid/boarman/boarman_idle.md5anim";
		desc.ATTACK_UPPER = "./data/models/humanoid/boarman/boarman_idle.md5anim";
