...
public class SandIgloo extends SmallBuilding {
	...
	public Residence getInstance(String id, Geography soilGeo, Place parent,
			...
			DistanceBasedBoundary homeBoundaries, EntityInstance owner) {
		try {
			return new SandIgloo(id,soilGeo,parent,loc,sizeX,sizeY,sizeZ,origoX,origoY,origoZ,groundLevel, homeBoundaries, owner);
		} catch (Exception ex)
		{
			ex.printStackTrace();
			System.exit(1);
